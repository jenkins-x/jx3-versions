...
declare -a repos=(
  # disabled  "jx3-kind"
  # local
  "jx3-kubernetes" "jx3-kubernetes-production" "jx3-kubernetes-bbc" "jx3-kubernetes-istio" "jx3-kubernetes-minio" "jx3-kubernetes-vault" "jx3-kind-gitea" "jx3-minikube" "jx3-docker-vault"
  # GKE
