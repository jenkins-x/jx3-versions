...
jx test create -f /workspace/source/.lighthouse/jenkins-x/bdd/tf.yaml --log --name-prefix=tf- -e TF_VAR_gcp_project=$PROJECT_ID -e TF_VAR_cluster_name=$CLUSTER_NAME
